...
async function unitCreate(unit) {
    ...
    if (!unit.Class)
        throw new Error('[MongoDb] Somthing went wrong on Class');
    switch (unit.Class) {
        case "Ranger":
            unit.Radius = 350;
            unit.baseDmg = 50;
    ...
    if ((!unit.name) ){
        throw new Error('[MongoDb] Somthing went wrong on name unit');
    }
    if ((!unit.HP) || (typeof (unit.HP) != 'number') || (unit.HP > unit.MaxHP) ){
        throw new Error('[MongoDb] Somthing went wrong on HP');
    }
    if ((!unit.MaxHP) || (typeof (unit.MaxHP) != 'number') ){
        throw new Error('[MongoDb] Somthing went wrong on Max HP');
    }
    if ((!unit.MP) || (typeof (unit.MP) != 'number') || (unit.MP > unit.MaxMP) ){
        throw new Error('[MongoDb] Somthing went wrong on MP');
    }
    if ((!unit.MaxMP) || (typeof (unit.MaxMP) != 'number') ){
        throw new Error('[MongoDb] Somthing went wrong on Max MP');
    }
    if ((!unit.Armor) || (typeof (unit.Armor) != 'number') ){
        throw new Error('[MongoDb] Somthing went wrong on Armor');
    }
    if ((!unit.mRes) || (typeof (unit.mRes) != 'number') ){
        throw new Error('[MongoDb] Somthing went wrong on Magic Resist');
    }
    if ((!unit.x) || (typeof (unit.x) != 'number') ){
        throw new Error('[MongoDb] Somthing went wrong on x position');
    }
    if ((!unit.y) || (typeof (unit.y) != 'number') ){
        throw new Error('[MongoDb] Somthing went wrong on y position');
    }
...
async function deleteUnit (unit) {
    ...
    if (!unit1){
        throw new Error(`[MongoDb] Something went wrong: ID is not exist!`);
        return;
    }
    if (!connected) {
        throw new Error(`[MongoDb] Something went wrong: Connection is not initialized!`);
...
async function attackUnit(ID){
    ...
    switch (unit1.Class) {
        ...
        case "Mage":
            ...
            break;
        default:
            throw new Error('[MongoDb] Somthing went wrong on Attack');
    }
